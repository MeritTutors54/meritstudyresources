                        ...
                        <div class="rbt-header-content">
                            ...
                            <div class="header-info">
                                <ul class="rbt-information-list">
                                    <li>
                                        <a href="mailto:<?php echo e($companyInformation->email); ?>">
                                            <i class="feather-email"></i><?php echo e($companyInformation->email); ?>
                        ...
                        <div class="rbt-header-content justify-content-start justify-content-lg-end">
                            <div class="header-info d-none d-xl-block">
                                <ul class="social-share-transparent">
                                    ...
                                    <li>
                                        <a href="<?php echo e($social->youtube); ?>"><i class="fab fa-youtube"></i></a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="header-info">
                        <div class="logo logo-dark">
                            <a href="<?php echo e(url('/')); ?>">
                                <img src="<?php echo e(asset('uploads/logo/'.$logo->logo)); ?>" alt="Merit Hub Logo Images">
                            </a>
                        </div>
                                    ...
                                    <div class="rbt-vertical-nav">
                                        <ul class="rbt-vertical-nav-list-wrapper vertical-nav-menu">
                                            ...
                                            <li class="vertical-nav-item">
                                                <a href="#tab<?php echo e(++$key); ?>"><?php echo e($category->category_name); ?></a>
                                            </li>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </ul>
                                    </div>
                                    <div class="rbt-vertical-nav-content">
                                        <?php $__currentLoopData = $allCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catekey => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="rbt-vertical-inner tab-content" id="tab<?php echo e(++$catekey); ?>"
                                            style="display: block">
                                            <div class="rbt-vertical-single">
                                                <div class="row">
                                                    <div class="col-lg-12 col-sm-12 col-12">
                                                        <div class="vartical-nav-content-menu">
                                                            <h3 class="rbt-short-title"><?php echo e($category->category_name); ?></h3>
                                                            <ul class="rbt-vertical-nav-list-wrapper">
                                                                ...
                                                                <?php $__currentLoopData = $allSubcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                 <li><a href="<?php echo e(url('resources')); ?>/<?php echo e($category->slug); ?>/<?php echo e($subcategory->slug); ?>"><?php echo e($subcategory->subcategory_name); ?></a></li>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </ul>
                                                        </div>
                                                    </div>
                    ...
                    <nav class="mainmenu-nav">
                        <ul class="mainmenu">
                            ...
                            <li class="has-dropdown has-menu-child-item">
                                ...
                                <ul class="submenu">
                                    <?php $__currentLoopData = $allCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $catekey => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="has-dropdown"><a href="#"><?php echo e($category->category_name); ?></a>
                                        <ul class="submenu">
                                            <?php
                                                $allSubcategory=App\Models\SubCategory::where('category_id',$category->id)->where('is_deleted',0)->where('is_active',1)->select(['subcategory_name','id','slug'])->get();
                                            ?>
                            ...
                            <li class="has-dropdown has-menu-child-item">
                                ...
                                <ul class="submenu">
                                    <li class=""><a href="<?php echo e(url('/blogs')); ?>">Blogs</a></li>
                                    <li class=""><a href="<?php echo e(url('/privacy-policy')); ?>">Privacy Policy</a></li>
                                    <li class=""><a href="<?php echo e(url('/terms-condition')); ?>">Terms Condition</a></li>
                ...
                <div class="header-right">
                    ...
                    <ul class="quick-access">
                        ...
                        <li class="account-access rbt-user-wrapper d-none d-xl-block">
                            ...
                            <a href="<?php echo e(url('/dashboard')); ?>"><i class="feather-user"></i>Dashboard</a>
                            <div class="rbt-user-menu-list-wrapper">
                                <div class="inner">
                                    <div class="rbt-admin-profile">
                                        <div class="admin-thumbnail">
                                            <img src="<?php echo e(asset('frontend')); ?>/assets/images/team/avatar.jpg" alt="User Images">
                                        </div>
                                        <div class="admin-info">
                                            <span class="name"><?php echo e(Auth::user()->name); ?></span>
                                            <a class="rbt-btn-link color-primary" href="<?php echo e(url('/profile')); ?>">View
                                                Profile</a>
                                        </div>
                                    </div>
                                    <ul class="user-list-wrapper">
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('/download-history')); ?>">
                                        ...
                                        <li>
                                            <a href="<?php echo e(url('/subcription-details')); ?>">
                                                <i class="feather-star"></i>
                                                <span>Subscription List</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo e(url('/purchase-history')); ?>">
                        ...
                        <li class="account-access rbt-user-wrapper d-none d-xl-block">
                            ...
                            <a href="<?php echo e(url('/login')); ?>"><i class="feather-user"></i>Login</a>
                ...
                <div class="row g-4 pt--30 pb--60">
                        ...
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="<?php echo e(asset('frontend')); ?>/assets/images/course/course-online-01.jpg" alt="Card image">
                                </a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="<?php echo e(asset('frontend')); ?>/assets/images/course/course-online-02.jpg" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="<?php echo e(asset('frontend')); ?>/assets/images/course/course-online-03.jpg" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                        <div class="rbt-card variation-01 rbt-hover">
                            <div class="rbt-card-img">
                                <a href="course-details.html">
                                    <img src="<?php echo e(asset('frontend')); ?>/assets/images/course/course-online-04.jpg" alt="Card image">
                                </a>
                            </div>
                            <div class="rbt-card-body">
                                <h5 class="rbt-card-title"><a href="course-details.html">Web Design</a>
    ...
    <div class="inner-wrapper">
        <div class="inner-top">
            <div class="content">
                <div class="logo">
                    <a href="index.html">
                        <img src="<?php echo e(asset('frontend')); ?>/assets/images/logo/logo.png" alt="Education Logo Images">
                    </a>
                </div>
                <div class="rbt-btn-close">
                            ...
                            <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="01-main-demo.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h1.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="12-marketplace.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h12.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="04-kindergarten.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h4.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="13-university-classic.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h13.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="14-home-elegant.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h14.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="09-gym-coaching.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h9.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="03-online-school.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h3.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="06-university-status.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h6.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="15-home-technology.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h15.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="07-instructor-portfolio.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h7.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="08-language-academy.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h8.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="11-single-course.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h11.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="10-online-course.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h10.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="05-classic-lms.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h5.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="02-course-school.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h2.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                        ...
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="16-udemy-affiliate.html"><img
                                                        src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/h16.jpg"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                ...
                                <div
                                    ...
                                    <div class="demo-single">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="#"><img src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/coming-soon-1.png"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                ...
                                <div
                                    ...
                                    <div class="demo-single">
                                        <div class="inner">
                                            <div class="thumbnail">
                                                <a href="#"><img src="<?php echo e(asset('frontend')); ?>/assets/images/splash/demo/coming-soon-2.png"
                                                        alt="Demo Images"></a>
                                            </div>
                                            <div class="content">
                                ...
                                <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                                    <div class="mega-category-item">
                                        ...
                                        <div class="nav-category-item">
                                            <div class="thumbnail">
                                                <div class="image"><img src="<?php echo e(asset('frontend')); ?>/assets/images/course/category-2.png"
                                        ...
                                        <div class="nav-category-item">
                                            <div class="thumbnail">
                                                <div class="image"><img src="<?php echo e(asset('frontend')); ?>/assets/images/course/category-1.png"
                                                        alt="Course images"></div>
                                                <a href="course-filter-one-toggle.html">
                                        ...
                                        <div class="nav-category-item">
                                            <div class="thumbnail">
                                                <div class="image"><img src="<?php echo e(asset('frontend')); ?>/assets/images/course/category-4.png"
                                                        alt="Course images"></div>
                                                <a href="course-filter-one-toggle.html">
                                        ...
                                        <div class="nav-category-item">
                                            <div class="thumbnail">
                                                <div class="image"><img src="<?php echo e(asset('frontend')); ?>/assets/images/course/category-9.png"
                                                        alt="Course images"></div>
                                                <a href="course-filter-one-toggle.html">
                                                    <span>Academy</span>
                                                    <i class="feather-chevron-right"></i>
                            ...
                            <div class="row row--15">
                                ...
                                <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                                    <div class="rbt-ads-wrapper">
                                        <a class="d-block" href="#"><img src="<?php echo e(asset('frontend')); ?>/assets/images/service/mobile-cat.jpg"
        ...
        <nav class="side-nav w-100">
            <ul class="rbt-minicart-wrapper">
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="<?php echo e(asset('frontend')); ?>/assets/images/product/1.jpg" alt="Product Images">
                        </a>
                    </div>
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="<?php echo e(asset('frontend')); ?>/assets/images/product/7.jpg" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="<?php echo e(asset('frontend')); ?>/assets/images/product/3.jpg" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
                ...
                <li class="minicart-item">
                    <div class="thumbnail">
                        <a href="#">
                            <img src="<?php echo e(asset('frontend')); ?>/assets/images/product/4.jpg" alt="Product Images">
                        </a>
                    </div>
                    <div class="product-content">
...
<!-- End Side Vav -->
<a class="close_side_menu" href="javascript:void(0);"></a><?php /**PATH /home/merithub.co.uk/public_html/core/resources/views/frontend/include/header.blade.php ENDPATH**/ ?>