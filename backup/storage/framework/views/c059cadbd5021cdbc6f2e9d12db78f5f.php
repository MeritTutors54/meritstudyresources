            ...
            <div class="col-md-2"></div>
                <div class="col-md-8 mt-10" style="padding-top: 106px;padding-bottom: 66px;">
                    ...
                    <form method="POST" action="<?php echo e(route('verify.code')); ?>"> 
                        ...
                        <input type="number" hidden value="<?php echo e($id); ?>" name="id">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\ResourceProject\resources\views/auth/verify.blade.php ENDPATH**/ ?>