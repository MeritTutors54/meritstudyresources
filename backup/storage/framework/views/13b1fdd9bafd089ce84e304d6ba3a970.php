            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="inner text-start">
                        <h2 class="title"><span class="text-decoration-underline" style="color:#fff !important">Merit Study Resources</span> Examiner-crafted revision resources designed to double your grades</h2>
                        <p class="description">MeritStudyResource is the stress-free solution for effective study, helping students achieve results beyond their expectations</p>
                        <div class="slider-btn rbt-button-group justify-content-start">
                            <a class="rbt-btn btn-border icon-hover color-white radius-round" href="<?php echo e(url('/individuals-pricing')); ?>">
                                <span class="btn-text">Explore Price</span>
                                <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                            </a>
                            <a class="rbt-btn-link color-white" href="<?php echo e(url('/contact')); ?>">Contact Us<i
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a class="rbt-cat-box rbt-cat-box-1 image-overlaping-content on-hover-content-visible"
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('frontend')); ?>/assets/images/category/image/personal-development.jpg" alt="Icons Images">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a class="rbt-cat-box rbt-cat-box-1 image-overlaping-content on-hover-content-visible"
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('frontend')); ?>/assets/images/category/image/graphic-design.jpg" alt="Icons Images">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a class="rbt-cat-box rbt-cat-box-1 image-overlaping-content on-hover-content-visible"
                        ...
                        <div class="inner">
                            <div class="thumbnail">
                                <img src="<?php echo e(asset('frontend')); ?>/assets/images/category/image/software.jpg" alt="Icons Images">
                            </div>
                            <div class="content">
                ...
                <div class="col-lg-6">
                    <div class="thumbnail-wrapper">
                        ...
                        <div class="thumbnail image-3 d-none d-md-block">
                            <img data-parallax='{"x": 0, "y": 80}' src="<?php echo e(asset('frontend')); ?>/assets/images/about/about-03.png"
                ...
                <div class="col-lg-6">
                    <div class="inner pl--50 pl_sm--0 pl_md--0">
                        <div class="section-title text-start">
                            ...
                            <h2 class="title">Achieve Your Best Grades  <br /> with MeritStudyResource's Expert Revision Resources</h2>
                        </div>

                        <p class="description mt--30">Prepare with confidence using MeritStudyResource’s comprehensive study guides and exam-ready resources. Our revision materials are meticulously structured to align with the latest exam board requirements, giving you the edge in your studies.</p>
                        ...
                        <div class="about-btn mt--40">
                            <a class="rbt-btn btn-gradient hover-icon-reverse" href="<?php echo e(url('/about-us')); ?>">
                ...
                <div class="row g-5 align-items-end mb--60">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="section-title text-start">
                            ...
                            <p class="description color-white-off mt--20">Elevate your study and preparation with MeritStudyResource—your gateway to academic success and a brighter future.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="load-more-btn text-start text-lg-end">
                            <a class="rbt-btn btn-border icon-hover radius-round color-white-off" href="<?php echo e(url('/blogs')); ?>">
                            ...
                            <div class="rbt-card-body">
                                <ul class="meta-list justify-content-start mb--30">
                                    <li class="list-item">
                                        ...
                                        <span><?php echo e($blogs->created_at->format('d M Y')); ?></span>
                                    </li>
                                </ul>
                                <h4 class="rbt-card-title"><a href="<?php echo e(url('blog-details/'.$blogs->slug)); ?>"><?php echo e($blogs->title); ?></a></h4>
                                <div class="rbt-card-bottom mt--40">
                                    <a class="transparent-button" href="<?php echo e(url('blog-details/'.$blogs->slug)); ?>">Learn
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        ...
                        <form action="<?php echo e(url('subscribe')); ?>" class="newsletter-form-1 mt--50 radius-round" method="POST">
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/merithub.co.uk/public_html/core/resources/views/frontend/home/index.blade.php ENDPATH**/ ?>
