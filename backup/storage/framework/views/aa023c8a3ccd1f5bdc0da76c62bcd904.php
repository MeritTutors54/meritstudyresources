            ...
            <div class="row mt--50">
                <div class="col-lg-6">
                    <div class="rbt-button-group">
                        ...
                        ?>
                        <?php $__currentLoopData = $allSeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $series): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a class="rbt-btn <?php if($key==0): ?> btn-secondary <?php endif; ?> <?php if($key==1): ?> btn-coral <?php endif; ?> <?php if($key==2): ?> btn-violet <?php endif; ?> <?php if($key==3): ?> btn-white <?php endif; ?> <?php if($key==4): ?> btn-pink <?php endif; ?>" href="<?php echo e(url('exam-series',$series->slug)); ?>"><?php echo e($series->exam_name); ?></a>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\ResourceProject\resources\views/frontend/pastpapers/index.blade.php ENDPATH**/ ?>