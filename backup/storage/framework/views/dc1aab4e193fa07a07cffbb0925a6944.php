<div class="rbt-default-sidebar-wrapper">
    ...
    <nav class="mainmenu-nav">
        <ul class="dashboard-mainmenu rbt-default-sidebar-list">
            <li><a href="<?php echo e(url('/dashboard')); ?>"><i
            ...
            <li><a href="<?php echo e(url('/download-history')); ?>"><i
                        class="feather-book-open"></i><span>Download History</span></a></li>
            <li><a href="<?php echo e(url('/subcription-details')); ?>"><i
                            class="feather-book-open"></i><span>Subscription List</span></a></li>
            <li><a href="<?php echo e(url('/wishlist')); ?>"><i
                        class="feather-bookmark"></i><span>Wishlist</span></a>
            </li>
            
  
            <li><a href="<?php echo e(url('/purchase-history')); ?>"><i
    ...
    <nav class="mainmenu-nav">
        <ul class="dashboard-mainmenu rbt-default-sidebar-list">
            <li><a href="<?php echo e(url('/edit-profile')); ?>"><i
...
</div><?php /**PATH F:\xampp\htdocs\ResourceProject\resources\views/frontend/dashboard/include/menu.blade.php ENDPATH**/ ?>