    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="main-card mb-3 card">
                    ...
                    <div>
                    <form action="<?php echo e(url('admin/past-paper/create')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/merithub.co.uk/public_html/core/resources/views/backend/pastpaper/create.blade.php ENDPATH**/ ?>