                            ...
                            <div class="col-md-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">Update Logo</h5>
                                        <div>
                                        <form action="<?php echo e(url('admin/logo/update')); ?>" method="post" enctype="multipart/form-data">
                                            <?php echo csrf_field(); ?>
                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body"><h5 class="card-title">All Image</h5>
                                        <table class="mb-0 table table-sm">
                                            ...
                                            <tr>
                                                <th scope="row">#</th>
                                                <td><img src="<?php echo e(asset('uploads/logo/'.$data->logo)); ?>" alt="logo" height="35px"></td>
                                                <td><img src="<?php echo e(asset('uploads/logo/'.$data->favicon)); ?>" alt="logo"  height="25px"></td>
                                                <td><img src="<?php echo e(asset('uploads/logo/'.$data->lazyloader)); ?>" alt="logo"  height="35px"></td>
                                            </tr>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\MeritTutorsProjectUpdate\ResourceProject\resources\views/backend/logo/index.blade.php ENDPATH**/ ?>