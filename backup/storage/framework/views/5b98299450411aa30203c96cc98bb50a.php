    ...
    <div class="row">
        <div class="offset-2 col-md-8">
            <div class="main-card mb-3 card">
                    ...
                    <div>
                    <form action="<?php echo e(url('/admin/blogs/update')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        
                        <div class="position-relative form-group"><label for="exampleFile" class="">Title</label>
                            <input type="text" class="form-control" name="title"  placeholder="Enter Title" value="<?php echo e($edit->title); ?>">
                            ...
                            <select class="form-control" name="category" id="category_id">
                                <option disabled selected>Select</option>
                                    <?php $__currentLoopData = $allCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($cate->id); ?>" <?php echo e($edit->category == $cate->id ? 'selected' : ''); ?>><?php echo e($cate->name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="position-relative form-group"><label for="exampleFile" class="">Tags</label>
                            <input type="text" class="form-control" name="tags"  placeholder="Enter Tags"  value="<?php echo e($edit->tags); ?>">
                        </div>
                      
                        <br>
                        <div class="position-relative form-group"><label for="exampleFile" class="">Blog Details</label>
                            <textarea type="text" id="summernote" class="form-control" name="details"  placeholder="Enter Details"> <?php echo e($edit->details); ?></textarea>
                        </div>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\ResourceProject\resources\views/backend/blogs/update.blade.php ENDPATH**/ ?>