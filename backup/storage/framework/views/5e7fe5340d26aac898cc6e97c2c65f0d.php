            ...
            <div class="main-card mb-3 card">
                    ...
                    <form action="<?php echo e(url('admin/admin-user/create')); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="position-relative form-group"><label for="exampleFile" class="">Name</label>
                            <input type="text" class="form-control" name="name"  placeholder="Enter Name" required value="<?php echo e($edit->name); ?>">
                            <input type="hidden" name="id"  value="<?php echo e($edit->id); ?>">
                        </div>
                        <br>
                        <div class="position-relative form-group"><label for="exampleFile" class="">User Name</label>
                            <input type="text" class="form-control" name="user_name"  placeholder="Enter User Name" required value="<?php echo e($edit->user_name); ?>">
                        </div>
                        <br>
                        <div class="position-relative form-group"><label for="exampleFile" class="">User Role</label>
                            <select  class="form-control" name="user_role" required>
                                ...
                                <?php $__currentLoopData = $allRole; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($role->id); ?>" <?php if($edit->user_role==$role->id): ?> selected <?php endif; ?>><?php echo e($role->role_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        <br>
                        <div class="position-relative form-group"><label for="exampleFile" class="">Email </label>
                            <input type="text" class="form-control" name="email"  placeholder="Enter Email" required value="<?php echo e($edit->email); ?>">
                        </div>
                        <br>
                        <div class="position-relative form-group"><label for="exampleFile" class="">Phone </label>
                            <input type="text" class="form-control" name="phone"  placeholder="Enter Phone" required value="<?php echo e($edit->phone); ?>" >
                        </div>
                        <br>
                   
                        <div class="position-relative form-group"><label for="exampleFile" class="">Address </label>
                            <textarea class="form-control" name="address"  placeholder="Enter Address"><?php echo e($edit->address); ?></textarea>
                        </div>
                        <br>
    ...
    <div class="row">
        <div class="col-md-10">
            <div class="main-card mb-3 card">
                    ...
                    <div>
                    <form action="<?php echo e(url('admin/admin-user/password-update')); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.backend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\xampp\htdocs\ResourceProject\resources\views/backend/adminuser/update.blade.php ENDPATH**/ ?>