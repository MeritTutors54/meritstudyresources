            ...
            <div class="pp-level-group">
                ...
                <div class="pp-level-body-cs" id="lvl-{{ $category->id }}"
                    ...
                    @if($popularSubcategories->isNotEmpty())
                        <button class="title-scope-btn" data-target="subBio-mp-class-{{ $category->id }}">
                        ...
                        <div class="px-4" id="subBio-mp-class-{{ $category->id }}" style="display: none;">
                    ...
                    @if($category->subcategories->isNotEmpty())
                        ...
                        <div class="px-4" id="subBio-mp-ww-class-{{ $category->id }}" style="display: none;">
