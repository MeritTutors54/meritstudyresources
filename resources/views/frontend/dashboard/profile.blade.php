@extends('layouts.frontend', ['main_title' => 'Profile - MeritStudyResources.co.uk' ])
@section('content')
                                ...
                                <div class="content">
                                    ...
                                    <div class="rbt-profile-row row row--15">
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <div class="rbt-profile-content b2">
                                                <span
                                                    class="rbt-badge-6 bg-secondary-opacity">{{ Auth::user()->roles()->first()->name }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="rbt-profile-row row row--15 mt--15">
                                        ...
                                        <div class="col-lg-8 col-md-8">
                                            <div
                                                class="rbt-profile-content b2">{{ Auth::user()->created_at->format('F j, Y g:i a') }}</div>
                                        </div>
                                    </div>
                                    <!-- End Profile Row  -->
