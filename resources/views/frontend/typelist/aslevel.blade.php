...
@section('title','AS Level Subjects')
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="content text-start">
                        <ul class="page-list">
                            ...
                            <li class="rbt-breadcrumb-item active">As Level</li>
                        </ul>
                    ...
                    <div class="course-details-content">
                        <div class="rbt-course-feature-box rbt-shadow-box details-wrapper mt--30" id="">
                            <div class="row g-5">
                                <!-- Start Feture Box  -->
                                <div class="col-lg-12">
                                    <p class="description">As Level Subjects</p>
                                </div>
                                @foreach ($allData as $data)
                                <div class="col-lg-3">
                                    {{-- <a href="{{ url('pastpapers',$category->slug.'/'.$subcategory->slug.'/'.$resubcategory->slug) }}"> --}}
                                    <a href="{{ url('resources/as-level/'.$data->slug) }}">
