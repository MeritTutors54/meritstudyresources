@extends('layouts.frontend', ['main_title' => $defaultSEO->meta_title ?? 'Payment - MeritStudyResources.co.uk' ])
@section('page-seo')
...
@section('content')
                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-inner text-center">
                        ...
                        <ul class="page-list">
                            ...
                            <li class="rbt-breadcrumb-item active">Payment</li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="checkout_area bg-color-white">
        <div class="container">
            <form action="{{ route('user.complete.payment', [$order->invoice_number]) }}" method="post" id="card-payment-form">
                @csrf
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="mt-4 single-method">
                            ...
                            <label for="accept_terms">
                                ...
                                <a target="__blank" style="color: #0d6efd" href="{{ route('terms-condition') }}">
                                    terms & conditions
                                </a>
                            </label>
                        ...
                        <div class="row pl--50 pl_md--0 pl_sm--0">
                            ...
                            <div class="col-12 mb--60">
                                <div class="checkout-cart-total">
                                    <h4 class="mt--30">Grand Total <span id="grand-total">£ {{ $payable_amount }}</span></h4>
                                    <div class="d-flex justify-content-end">
                                        <button type="submit"
                                            ...
                                            <span class="icon-reverse-wrapper">
                                                <span class="btn-text">Pay & Place order</span>
...
@section('js')
    ...
    <script>
        ...
        form.addEventListener('submit', async (e) => {
            ...
            console.log(stripe, cardHolderField.value);
