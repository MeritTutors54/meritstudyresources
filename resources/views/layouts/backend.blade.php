...
<head>
    ...
    <!-- Style-->
    <link rel="stylesheet" href="{{ asset('backend/assets/css/style.css?v=' . $v) }}">
    <link rel="stylesheet" href="{{ asset('backend/assets/css/skin_color.css?v=' . $v) }}">

    <link rel="stylesheet" href="{{ asset('backend/assets/css/update.css?v=' . $v) }}">
    @yield('page-css')
</head>
...
{{--                                <img src="{{ asset('backend/assets/images/avatar/2.jpg') }}" class="avatar avatar-lg">--}}
{{--                            </span>--}}
{{--                        <div class="mx-10">--}}
...
{{--                        </div>--}}
{{--                        <span class="msg-avatar">--}}
{{--                                <img src="{{ asset('backend/assets/images/avatar/3.jpg') }}" class="avatar avatar-lg">--}}
{{--                            </span>--}}
{{--                    </div>--}}
{{--                    <div class="cm-msg-text">--}}
...
<!-- Vendor JS -->
<script src="{{ asset('backend/assets/js/vendors.min.js?v=' . $v) }}"></script>
<script src="{{ asset('backend/assets/js/pages/chat-popup.js?v=' . $v) }}"></script>
<script src="{{ asset('backend/assets/icons/feather-icons/feather.min.js?v=' . $v) }}"></script>
...
<script src="{{ asset('backend/assets/js/pages/dashboard3.js?v=' . $v) }}"></script>
<script src="{{ asset('backend/assets/js/pages/calendar.js?v=' . $v) }}"></script>
