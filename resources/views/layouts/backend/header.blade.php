            ...
            <div class="logo-lg">
                <span class="light-logo">
                    @if (!empty($settings->site_logo))
                        <img src="{{ asset(\Illuminate\Support\Facades\Storage::url($settings->site_logo)) }}"
                            alt="logo">
                    @else
                        <img src="{{ asset('backend/assets/images/logo-dark-text.png') }}" alt="logo">
                    @endif
                </span>
                <span class="dark-logo">
                    <img src="{{ asset('backend/assets/images/logo-light-text.png') }}" alt="logo">
                </span>
            </div>
        </a>
    </div>
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="app-menu">
            <ul class="header-megamenu nav">
                ...
                {{--                </li> --}}
                <li class="btn-group nav-item d-none d-xl-inline-block">
                    <a class="waves-effect waves-light nav-link svg-bt-icon go-live" target="_blank"
                        href="{{ route('home') }}">
                ...
                <li class="btn-group nav-item d-none d-xl-inline-block">
                    <div class="mt-3 ms-3">
                        ...
                        <span class="ms-3 badge badge-primary">
                ...
                @can('viewForAdminRole', Auth::user())
                    <li class="btn-group nav-item d-none d-xl-inline-block">
                        <a href="{{ route('admin.permission.index') }}"
                            class="waves-effect waves-light nav-link svg-bt-icon" title="Mailbox">
                            <i class="icon-Mailbox">
                                <span class="path1"></span><span class="path2"></span>
                            </i>
                        </a>
                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu animated flipInX">
                        <li class="user-body">
                            ...
                            {{--                                <i class="ti-wallet text-muted me-2"></i> --}}
                            {{--                                My Wallet --}}
                            {{--                            </a> --}}
                            {{--                            <a class="dropdown-item" href="#"> --}}
