                    ...
                    <span class="light-logo">
                        @if(!empty($settings->site_logo))
                            <img src="{{ asset(\Illuminate\Support\Facades\Storage::url($settings->site_logo)) }}"
                                 alt="logo">
                        @else
                            <img src="{{ asset('backend/assets/images/logo-dark-text.png') }}"
                             alt="logo">
                        @endif
                    </span>
                <span class="dark-logo">
                        <img src="{{ asset('backend/assets/images/logo-light-text.png') }}"
                             alt="logo">
                    </span>
            </div>
        </a>
    ...
    <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu r-side">
            <ul class="nav navbar-nav">
                ...
                <li class="btn-group nav-item d-none d-xl-inline-block">
                    <a href="{{ route('admin.permission.index') }}" class="waves-effect waves-light nav-link svg-bt-icon" title="Mailbox">
                        <i class="icon-Mailbox">
                            <span class="path1"></span><span class="path2"></span>
                        </i>
                    </a>
