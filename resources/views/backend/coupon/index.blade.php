                                            ...
                                            @foreach($coupons as $coupon)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($coupon->status === \App\Enums\Status::ACTIVE->value)
                                                            <span class="badge badge-success">
                                                                {{ ucfirst(strtolower(\App\Enums\Status::from($coupon->status)->name)) }}
                                                            </span>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        @can('updateCoupon', Auth::user())
                                                            <a href="{{ route('admin.coupons.edit', [$coupon]) }}">
                                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                                            </a>
                                                        @endcan
                                                        @can('deleteCoupon', Auth::user())
                                                            <button type="button"
                                                                    data-route="{{ route('admin.coupons.destroy', [$coupon]) }}"
