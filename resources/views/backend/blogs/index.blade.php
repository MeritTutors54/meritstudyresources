                                            ...
                                            @foreach($blogs as $blog)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($blog->status === \App\Enums\Status::ACTIVE->value)
                                                            <span class="badge badge-success">
                                                                {{ ucfirst(strtolower(\App\Enums\Status::from($blog->status)->name)) }}
                                                            </span>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        @can('updateBlog', Auth::user())
                                                            <a href="{{ route('admin.blogs.edit', [$blog]) }}">
                                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                                            </a>
                                                        @endcan
                                                        @can('deleteBlog', Auth::user())
                                                            <button type="button"
                                                                    data-route="{{ route('admin.blogs.destroy', [$blog]) }}"
