                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Stuffs</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        @if(isset($stuffs) && $stuffs->isNotEmpty())
                                            @foreach($stuffs as $stuff)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($stuff->getRoleNames()->first() == 'admin')
                                                            <span class="badge badge-primary">
                                                                {{ $stuff->getRoleNames()->first() }}
                                                            </span>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        @can('updateStuffPermission', Auth::user())
                                                            <a href="{{ route('admin.stuff.permissions', [$stuff]) }}">
                                                                <i class="fa fa-th-list" aria-hidden="true"></i>
                                                            </a>
                                                        @endcan
                                                        @can('editStuff', Auth::user())
                                                            <a class="ms-5"
                                                               href="{{ route('admin.stuffs.edit', [$stuff]) }}">
                                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                                            </a>
                                                        @endcan
                                                        @can('deleteStuff', Auth::user())
                                                            <button type="button"
                                                                    data-route="{{ route('admin.stuffs.destroy', [$stuff]) }}"
                                                                    data-name="{{ $stuff->name }}"
