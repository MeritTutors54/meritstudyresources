                        ...
                        <div class="box">
                            ...
                            <div class="box-header with-border">
                                <div class="d-flex align-items-center">
                                    ...
                                    @can('createStudyMaterialSubject', Auth::user())
                                        ...
                                        @if(isset($subjects) && $subjects->isNotEmpty())
                                            @foreach($subjects as $subject)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @can('updateStudyMaterialSubject', Auth::user())
                                                            <a href="{{ route('admin.subjects.edit', [$subject]) }}">
                                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                                            </a>
                                                        @endcan
                                                        @can('deleteStudyMaterialSubject', Auth::user())
                                                            <button type="button"
                                                                    data-route="{{ route('admin.subjects.destroy', [$subject]) }}"
