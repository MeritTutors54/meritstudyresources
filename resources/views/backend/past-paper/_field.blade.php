        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="form-group">
                    ...
                    <select name="exam_series" id="exam_series" class="form-select"
                            required>
            ...
            <div class="col-lg-6 col-12">
                <div class="form-group">
                    ...
                    <select name="is_paid" id="is_paid" class="form-select">
                        <option {{ old('is_paid', $past_paper->is_paid ?? 0) == 1 ? 'selected' : '' }}
                                value="1">Paid
                        </option>
                        <option
                            {{ old('is_paid', $past_paper->is_paid ?? 0) == 0 ? 'selected' : '' }}
                            value="0">Free
                        </option>
                    </select>
                    @error('is_paid')
            ...
            <div class="col-lg-12 col-12 solutions-field" style="display: block;">
                    ...
                    <div class="box-body">
                        <div class="demo-checkbox">
                            ...
                            <input
                                ...
                                type="checkbox" name="have_pdf_solution" id="pdf_solution_id" class="chk-col-success"
                                value="1">
                ...
                @enderror
                <div class="form-group" style="display: {{ isset($past_paper) && $past_paper->have_video_solution == 1 ? 'block' : 'none' }}"
                     id="video_section">
                    <div class="box-body">
                        <div class="demo-checkbox">
                            <input
                ...
                <div class="form-group"
                    ...
                    <input type="text" class="form-control" name="video_links" placeholder="Please enter valid link">
                </div>
                <div class="form-group"
                ...
                <div class="form-group" style="display: {{ isset($past_paper) && $past_paper->have_pdf_solution == 1 ? 'block' : 'none' }}" id="pdf_solution_section">
