                        ...
                        <div class="d-inline-block align-items-center">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Year Groups</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="box">
                            ...
                            <div class="box-header with-border">
                                <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{ route('admin.year-groups.create') }}"
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                        @if(isset($year_groups) && $year_groups->isNotEmpty())
                                            @foreach($year_groups as $k => $group)
                                                <tr>
                                                    <td>{{ $k + 1 }}</td>
                                                    <td>{{ $group->year_name }}</td>
                                                    <td class="text-center">
                                                        <a href="{{ route('admin.year-groups.edit', [$group]) }}">
                                                            <i class="fa fa-edit" aria-hidden="true"></i>
                                                        </a>
                                                        <button type="button"
                                                                data-route="{{ route('admin.year-groups.destroy', [$group]) }}"
                                                                data-name="{{ $group->year_name }}"
