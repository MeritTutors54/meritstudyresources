                        ...
                        <div class="box">
                            ...
                            <div class="box-header with-border">
                                <div class="d-flex align-items-center">
                                    ...
                                    @can('createBookCategory', Auth::user())
                                        <a href="{{ route('admin.book-categories.create') }}"
                                        ...
                                        @if(isset($bookCategories) && $bookCategories->isNotEmpty())
                                            @foreach($bookCategories as $category)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        @if($category->status === \App\Enums\Status::ACTIVE->value)
                                                            <span class="badge badge-success">
                                                                {{ ucfirst(strtolower(\App\Enums\Status::from($category->status)->name)) }}
                                                            </span>
                                                        @else
                                                    ...
                                                    <td class="text-center">
                                                        @can('updateBookCategory', Auth::user())
                                                            <a href="{{ route('admin.book-categories.edit', [$category]) }}">
                                                                <i class="fa fa-edit" aria-hidden="true"></i>
                                                            </a>
                                                        @endcan
                                                        @can('deleteBookCategory', Auth::user())
                                                            <button type="button"
