...
Route::prefix('admin')->middleware(['auth:admin', 'team.permission'])->group(function () {
    ...
    */
    ...
    Route::get('/users/sub-cat-data', [AjaxController::class, 'subcategoryData'])->name('admin.ajax.table.getSubCategory');
    Route::get('/users/re-sub-cat-data', [AjaxController::class, 'resubcategoryData'])->name('admin.ajax.table.getReSubCategory');
